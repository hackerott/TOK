...
################################################################################	
	...
	for i in range(day, max_j):
		out_e1[i] = temp_max1[i]
		out_e2[i] = temp_max2[i]
		out_e3[i] = temp_max3[i]
		out_e4[i] = temp_max4[i]
		out_e5[i] = temp_max5[i]
		out_e6[i] = temp_max6[i]
		out_e7[i] = temp_max7[i]
		out_e8[i] = temp_max8[i]


################################################################################	
	for i in range(day, max_j):
	## day 1
		if out_e1[i] >= 23 and out_e1[i] < 30:
			prob_y[i] += 0.175
			val_y[i] += (0.175 * out_e1[i])
		elif out_e1[i] >= 30:
			prob_r[i] += 0.175 #vermelho
			val_r[i] += (0.175 * out_e1[i])
		elif 1 < out_e1[i] < 23: 
			prob_g[i] += 0.175 #verde
			val_g[i] += (0.175 * out_e1[i])
			
		if out_e2[i] >= 23 and out_e2[i] < 30:
			prob_y[i] += 0.175
			val_y[i] += (0.175 * out_e2[i])
		elif out_e2[i] >= 30:
			prob_r[i] += 0.175 #vermelho
			val_r[i] += (0.175 * out_e2[i])
		elif 1 < out_e2[i] < 23: 
			prob_g[i] += 0.175 #verde
			val_g[i] += (0.175 * out_e2[i])		

		if out_e3[i] >= 23 and out_e3[i] < 30:
			prob_y[i] += 0.175
			val_y[i] += (0.175 * out_e3[i])
		elif out_e3[i] >= 30:
			prob_r[i] += 0.175 #vermelho
			val_r[i] += (0.175 * out_e3[i])
		elif 1 < out_e3[i] < 23: 
			prob_g[i] += 0.175 #verde
			val_g[i] += (0.175 * out_e3[i])	

		if out_e4[i] >= 23 and out_e4[i] < 30:
			prob_y[i] += 0.175
			val_y[i] += (0.175 * out_e4[i])
		elif out_e4[i] >= 30:
			prob_r[i] += 0.175 #vermelho
			val_r[i] += (0.175 * out_e4[i])
		elif 1 < out_e4[i] < 23: 
			prob_g[i] += 0.175 #verde
			val_g[i] += (0.175 * out_e4[i])
## day 2
		if out_e5[i] >= 23 and out_e5[i] < 30:
			prob_y[i] += 0.075
			val_y[i] += (0.075 * out_e5[i])
		elif out_e5[i] >= 30:
			prob_r[i] += 0.075 #vermelho
			val_r[i] += (0.075 * out_e5[i])
		elif 1 < out_e5[i] < 23: 
			prob_g[i] += 0.075 #verde
			val_g[i] += (0.075 * out_e5[i])

		if out_e6[i] >= 23 and out_e6[i] < 30:
			prob_y[i] += 0.075
			val_y[i] += (0.075 * out_e6[i])
		elif out_e6[i] >= 30:
			prob_r[i] += 0.075 #vermelho
			val_r[i] += (0.075 * out_e6[i])
		elif 1 < out_e6[i] < 23: 
			prob_g[i] += 0.075 #verde
			val_g[i] += (0.075 * out_e6[i])
		
		if out_e7[i] >= 23 and out_e7[i] < 30:
			prob_y[i] += 0.075
			val_y[i] += (0.075 * out_e7[i])
		elif out_e7[i] >= 30:
			prob_r[i] += 0.075 #vermelho
			val_r[i] += (0.075 * out_e7[i])
		elif 1 < out_e7[i] < 23: 
			prob_g[i] += 0.075 #verde
			val_g[i] += (0.075 * out_e7[i])
		
		if out_e8[i] >= 23 and out_e8[i] < 30:
			prob_y[i] += 0.075
			val_y[i] += (0.075 * out_e8[i])
		elif out_e8[i] >= 30:
			prob_r[i] += 0.075 #vermelho
			val_r[i] += (0.075 * out_e8[i])
		elif 1 < out_e8[i] < 23: 
			prob_g[i] += 0.075 #verde
			val_g[i] += (0.075 * out_e8[i])	
...
#+ 0.5*(val_r[i]/prob_r[i]))/3
			...
			if val[i] >= 30:			
				...
				color[i] = 2
				prob[i] = 0.3
#		print "color", color[i],"prob", prob[i]*100,"val", val[i], "R", prob_r[i]*100, "G", prob_g[i]*100, "Y", prob_y[i]*100,  "I", i
