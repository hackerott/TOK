...
# 	mini	= [mini1, mini2, mini3, mini4, mini5]
	...
	if model == "meteo":
		clou1, pres1, temp1, humi1, rain1, wind1, dew1, cape1, gust1 = gfs_var._get_meteo('meteo', ens1, ix_gfs, iy_gfs)
		clou2, pres2, temp2, humi2, rain2, wind2, dew2, cape2, gust2 = gfs_var._get_meteo('meteo', ens2, ix_gfs, iy_gfs)
		date, prob, alert, value, maxi, mini = meteogram.DATA_gfs_meteo(temp1, temp2, wind1, wind2, humi1, humi2, cloud1, cloud2, rain1, rain2, pres1, pres2, cape1, cape2, dew1, dew2, time, ix_gfs, iy_gfs, date0, utc0)
	else:
		success, dic = json_output._get_ERROR(var_id, model)
